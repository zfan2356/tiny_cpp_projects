...
# This module provides support for various sanitizers in CMake projects.
#
# How to use:
#
...
#
# 2. Enable a specific sanitizer by setting the SANITIZER variable:
#    - For Address Sanitizer:
#      cmake -DSANITIZER=ASAN ..
#
#    - For Memory Sanitizer:
#      cmake -DSANITIZER=MSAN ..
#
#    - For Undefined Behavior Sanitizer:
#      cmake -DSANITIZER=UBSAN ..
#      Note: May have issues with coroutines when using clang++ v14.0.6
#
...
#    make
#
# 4. Run your executable - sanitizers will report issues automatically
#
# Additional notes:
# - Sanitizers may have performance impact
# - Some sanitizers cannot be combined
# - When using sanitizers, C++ new/delete operators are not overridden
#   (OVERRIDE_CXX_NEW_DELETE is automatically set to OFF)
