...
class CMakeBuild(build_ext):
    def build_extension(self, ext):
        ...
        subprocess.check_call(
            ["cmake", "-S", ext.sourcedir] + cmake_args, cwd=build_temp
        )
        subprocess.check_call(
            ["cmake", "--build", ".", "--target", "rdma_comm"] + build_args,
            cwd=build_temp,
        )
...
setup(
    name="rdma_comm",
    version=version,
    description="Python binding for rdma communication library",
    long_description="",
    ext_modules=[CMakeExtension("rdma_comm")],
